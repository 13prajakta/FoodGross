 <?php 
  ...
  $query1="SELECT  * FROM allpro  WHERE deleted=1 ";
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     <section class="content">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
             ...
             if (isset($_GET['message2'])) {
              ...
              <form role="form" method="post" action="getdataallp.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name of Product</label>
                    <input type="text" name="plantname" class="form-control" id="exampleInputEmail1" placeholder="Enter product name" required="">
                  </div>
                  <div class="form-group">
      ...
      <?php
        $con = new mysqli('localhost','root','','gross');
        $query2="SELECT * FROM allpro  WHERE deleted=1";
        $result2 = $con->query($query2);
            ...
            echo "<div class='card-title' >All PRODUCTS</div>"; 
            echo "</div>"; 
            ...
            echo " <a href='https://via.placeholder.com/1200/FFFFFF.png?text=1'data-toggle='lightbox' data-title='sample 1 - white' data-gallery='gallery'>";
             echo " <img src='uplode/$data->a_img'  width='200' height='170' class='img-fluid mb-2'>";        
            echo "<h3>$data->a_name</h3>";
            echo "<p>Plant Cost: $ $data->a_cost</p>";
            echo "<a href='editap.php?aid=$data->a_id' type='submit' class='btn btn-primary' value='submit' style='background-color: #148F77;float: left;padding: 6px 12;'>Edit</a>";
            echo "<a href='deleteap.php?aid=$data->a_id' type='close' class='btn btn-default' value='close' style='background-color: #CB4335;color: white;float: right;padding: 6px;'>Delete</a>";
              echo "</a>";      
              echo "</div>";
            }   
              echo "</div>";   
