<?php 
  ...
  $query1="SELECT  * FROM allpro  WHERE a_id = '$aid'";
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="updateap.php" enctype="multipart/form-data">
                <input type="hidden" name="aid" value="<?php echo $data->a_id ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name of Product</label>
                    <input type="text" name="plantname" class="form-control" id="exampleInputEmail1" placeholder="Enter plant name" required="" value="<?php echo $data->a_name ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Product Cost</label>
                    <input type="text" name="cost" class="form-control" id="exampleInputPassword1" placeholder="Enter cost" required="" value="<?php echo $data->a_cost?>">
                  </div>
                  <div class="form-group">
                    <label >Uplode Product Image</label>
                    <div class="input-group">
                        <input type="file" name="image"/><img src="<?php echo $data->a_imgpath ?>" selected="selected" width="100" height="100">                 
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
