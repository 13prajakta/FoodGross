<?php 
  ...
  $query1="SELECT  * FROM other  WHERE o_id = '$oid'";
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="updateo.php" enctype="multipart/form-data">
                <input type="hidden" name="oid" value="<?php echo $data->o_id ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name of Vegitable</label>
                    <input type="text" name="oname" class="form-control" id="exampleInputEmail1" placeholder="Enter product name" required="" value="<?php echo $data->o_name ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Product Cost</label>
                    <input type="text" name="cost" class="form-control" id="exampleInputPassword1" placeholder="Enter cost" required="" value="<?php echo $data->o_cost?>">
                  </div>
                  <div class="form-group">
                    <label >Uplode Product Image</label>
                    <div class="input-group">
                        <input type="file" name="image" ><img src="<?php echo $data->o_imgpath ?>" selected="selected" width="100" height="100">                 
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
