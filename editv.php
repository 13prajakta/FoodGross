<?php 
  ...
  $query1="SELECT  * FROM veg  WHERE v_id = '$vid'";
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="updatev.php" enctype="multipart/form-data">
                <input type="hidden" name="vid" value="<?php echo $data->v_id ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name of Vegitable</label>
                    <input type="text" name="vegname" class="form-control" id="exampleInputEmail1" placeholder="Enter plant name" required="" value="<?php echo $data->v_name ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Product Cost</label>
                    <input type="text" name="cost" class="form-control" id="exampleInputPassword1" placeholder="Enter cost" required="" value="<?php echo $data->v_cost?>">
                  </div>
                  <div class="form-group">
                    <label >Uplode Product Image</label>
                    <div class="input-group">
                        <input type="file" name="image" ><img src="<?php echo $data->v_imgpath ?>" selected="selected" width="100" height="100">                 
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
