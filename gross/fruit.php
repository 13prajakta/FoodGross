<?php 
  ...
  $query = "SELECT * FROM fruit WHERE deleted=1";
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="cart.php"><i class="fas fa-shopping-bag" style="color: black;padding: 0;"></i> &nbsp;Cart</a></li>
                </ul>
                  </li>
                </ul>
              </div><!-- /.navbar-collapse -->
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-5">
            <ul class="nav nav-pills">
              ...
              <li role="presentation" class="active"><a href="fruit.php">FRUITS</a></li>
              <li role="presentation"><a href="veg.php">VEGITABLES</a></li>
      ...
      while ($data= $result->fetch_object()){
       ...
       echo" <div class='col-md-3'>";
          echo"<div class='thumbnail'>";
           echo" <img src='../$data->f_imgpath' alt='...' class='image'>";
           echo" <div class='caption'>";
             echo" <h3>$data->f_name</h3>";
             echo" <p>$ $data->f_cost</p>";
             echo" <div class='overlay'>";
             echo" <div class='text'><a href='cart_fruit.php?fc=$data->f_id'><i class='fas fa-shopping-bag'></i></a></div>";
            echo"</div>";
           echo" </div>";
          echo"</div>";
           echo"</div>";
       ...
       echo" </div>";
      echo"<div class='row'>";
        echo"<div class='col-md-12 text-center show'>";
          echo"<a href='' class='btn btn-default'>Show More</a>";
        echo"</div>";
      echo"</div>";
       echo" </div>";
    ?>
          ...
          <div class="carousel slide multi-item-carousel" id="theCarousel">
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-xs-4">
                  <p><strong>"</strong>Your Product Are Awsome <strong>"</strong></p>
              ...
              <div class="item">
                <div class="col-xs-4">
                  <p><strong>"</strong>Your Product Are Awsome <strong>"</strong></p><a href="#1"><img src="images/persone.jpg" class="img-responsive img-circle" width="50%"></a>
                <p>Thomas B.</p></div>
