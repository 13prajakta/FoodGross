<?php 
  ...
  $query = "SELECT * FROM allpro WHERE deleted=1";
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-5">
            <ul class="nav nav-pills">
              <li role="presentation" class="active"><a href="index.php">ALL PRODUCTS</a></li>
      ...
      while ($data= $result->fetch_object()){
       ...
       echo" <div class='col-md-3'>";
          echo"<div class='thumbnail'>";
           echo" <img src='../$data->a_imgpath' alt='...' class='image'>";
           echo" <div class='caption'>";
             echo" <h3>$data->a_name</h3>";
             echo" <p>$ $data->a_cost</p>";
             echo" <div class='overlay'>";
             echo" <div class='text'><a href='cart_all.php?ac=$data->a_id'><i class='fas fa-shopping-bag'></i></a></div>";
            echo"</div>";
           echo" </div>";
          echo"</div>";
          echo"</div>";
