<?php 
  ...
  $query = "SELECT * FROM other WHERE deleted=1";
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-5">
            <ul class="nav nav-pills">
              ...
              <li role="presentation" class="active"><a href="other.php">OTHERS</a></li>
            </ul>
          </div>
      ...
      while ($data= $result->fetch_object()){
       ...
       echo" <div class='col-md-3'>";
          echo"<div class='thumbnail'>";
           echo" <img src='../$data->o_imgpath' alt='...' class='image'>";
           echo" <div class='caption'>";
             echo" <h3>$data->o_name</h3>";
             echo" <p>$ $data->o_cost</p>";
             echo" <div class='overlay'>";
             echo" <div class='text'><a href='cart_other.php?oc=$data->o_id'><i class='fas fa-shopping-bag'></i></a></div>";
            echo"</div>";
           echo" </div>";
          echo"</div>";
           echo"</div>";
