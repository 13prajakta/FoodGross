 <?php 
  ...
  $query1="SELECT  * FROM veg  WHERE deleted=1 ";
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="veg.php" class="nav-link active">
                  <i class="far fa-circle text-info nav-icon"></i>
                  <p>Vegitable</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     <section class="content">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
             ...
             if (isset($_GET['message2'])) {
              ...
              <form role="form" method="post" action="getdataveg.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name of Vegitable</label>
                    <input type="text" name="vegname" class="form-control" id="exampleInputEmail1" placeholder="Enter product name" required="">
                  </div>
                  <div class="form-group">
      ...
      <?php
        $con = new mysqli('localhost','root','','gross');
        $query2="SELECT * FROM veg  WHERE deleted=1";
        $result2 = $con->query($query1);
            ...
            echo "<div class='card-title' >VEGITABLES</div>"; 
            echo "</div>"; 
            ...
            echo " <a href='https://via.placeholder.com/1200/FFFFFF.png?text=1'data-toggle='lightbox' data-title='sample 1 - white' data-gallery='gallery'>";
             echo " <img src='uplode/$data->v_img'  width='200' height='170' class='img-fluid mb-2'>";        
            echo "<h3>$data->v_name</h3>";
            echo "<p>Plant Cost: $ $data->v_cost</p>";
            echo "<a href='editv.php?vid=$data->v_id' type='submit' class='btn btn-primary' value='submit' style='background-color: #148F77;float: left;padding: 6px 12;'>Edit</a>";
            echo "<a href='deletev.php?vid=$data->v_id' type='close' class='btn btn-default' value='close' style='background-color: #CB4335;color: white;float: right;padding: 6px;'>Delete</a>";
              echo "</a>";      
              echo "</div>";
            }   
              echo "</div>";   
